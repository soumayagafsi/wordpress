 ...
 */
function callcenter_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function callcenter_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function callcenter_sanitize_html( $html ) {
 ...
 */
function callcenter_sanitize_image( $image, $setting ) {
 ...
 */
function callcenter_sanitize_nohtml( $nohtml ) {
 ...
 */
function callcenter_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function callcenter_sanitize_range_value( $number, $setting ) {
 ...
 */
function callcenter_sanitize_select( $input, $setting ) {
 ...
 */
function callcenter_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function callcenter_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function callcenter_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
